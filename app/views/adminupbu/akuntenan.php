                    ...
                    <table id="tableSearch" class="table  table-hover">
                        <thead>
                            <tr>
                                ...
                                <th class="d-none d-lg-table-cell" scope="col">Tenan</th>
                        ...
                        <tbody>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a href="<?= BASEURL ?>Dashboardupbu/del/<?= $vals['acount_id'] ?>"
                            ...
                            <!-- Modal Lihat-->
                            <div class="modal fade" id="show<?= $vals['acount_id'] ?>" tabindex="-1"
                                aria-labelledby="exampleModalLabel" aria-hidden="true">
                            ...
                            <div class="modal fade" id="update<?= $vals['acount_id'] ?>" tabindex="-1"
                                aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <form action="<?= BASEURL ?>Dashboardupbu/updateAkunTenan/<?= $vals['acount_id'] ?>"
                                        method="post">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select disabled required name="tenan_id" type="text"
                                                        class="form-control" id="">
                                                        <?php foreach ($data['tenan'] as $value) : ?>
                                                        <option <?php if ($vals['tenan_id'] == $vals['tenan_id']) {
